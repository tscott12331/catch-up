"""Deterministic data owned by the demo infrastructure adapter.

Application services consume this data only through ``RepositoryContentSource``;
the browser receives it only through public API responses.
"""
...
from ...domain.repository import Repository, SourcePassage, TreeNode
